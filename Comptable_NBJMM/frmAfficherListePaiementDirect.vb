...
Public Class frmAfficherListePaiementDirect
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If (ListView1.SelectedItems.Count > 0) Then
            frmUpdate_Paiement_direct.Show()
            frmUpdate_Paiement_direct.Label13.Text = ListView1.SelectedItems(0).SubItems(0).Text

            'Me.Hide()
            Me.Close()
            frmMenu.Close()
            frmUpdate_Paiement_direct.MdiParent = Form_windows
            frmUpdate_Paiement_direct.Show()
