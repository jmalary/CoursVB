...
Public Class frmUpdate_fournisseur
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim myCommand As New OleDb.OleDbCommand("update check_emis set nom = @description, date_paiement = @date_paiement, un = @un, deux = @deux, trois = @trois, quatre = @quatre, cinq = @quatre WHERE numero = @numero", myConnection)
