...
Public Class frmPaiement
    ...
    Sub proc_A()
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            'lblerreur.Text = ""
            MsgBox("Paiement direct ajoutée")
    ...
    Private Sub proc_liste_mensuel()
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            MsgBox("Paiement préautorise mensuel ajoutée")
            TextBox1.Text = ""
    ...
    Private Sub proc_liste_mi_mensuel()
        ...
        If NumDay < ComboBox3.Text And NumDay < ComboBox4.Text Then
            'newDate.Day = ComboBox3.Text
            ...
            lister.Add(newDate1)
            lister.Add(newDate2)
        ElseIf NumDay > ComboBox3.Text And NumDay < ComboBox4.Text Then
            newDate2 = New Date(DateCourant.Year.ToString, DateCourant.Month.ToString, ComboBox4.Text)
            lister.Add(newDate2)
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            MsgBox("Paiement préautorise mi-mensuel ajoutée")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If MsgBox("Êtes-vous sûr de vouloir quitter?", MsgBoxStyle.YesNo Or MsgBoxStyle.DefaultButton2, "Close application") = Windows.Forms.DialogResult.Yes Then
            Me.Close()
        End If
    End Sub
End Class