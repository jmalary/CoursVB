...
Public Class frmUpdate_Paiement_direct
    ...
    Private Sub frmUpdate_Paiement_direct_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim numero As String = frmAfficherListePaiementDirect.ListView1.SelectedItems(0).SubItems(0).Text
        'Dim numero As String = Label2.Text

        Dim myConnection As New OleDb.OleDbConnection(myConnString)
        myConnection.Open()

        Dim myCommand As New OleDb.OleDbCommand("SELECT * FROM check_direct where numero = " & numero & "", myConnection)
        ...
        While myReader.Read
            ...
            Label9.Text = myReader.GetDateTime(2)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim myCommand As New OleDb.OleDbCommand("Update check_direct set nom = @description, date_paiement = @date_paiement, un = @un, deux = @deux, trois = @trois, quatre = @quatre, cinq = @cinq WHERE numero = @numero", myConnection)
        myCommand.Parameters.AddWithValue("@description", ComboBox1.SelectedValue.ToString)
        myCommand.Parameters.AddWithValue("@date_paiement", DateTimePicker1.Value.ToString())
